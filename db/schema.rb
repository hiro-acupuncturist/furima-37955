...
ActiveRecord::Schema.define(version: 2022_06_12_052546) do
  ...
  create_table "deliveries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchaserecord_id"], name: "index_deliveries_on_purchaserecord_id"
  end
  ...
  create_table "purchaserecords", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
  ...
  add_foreign_key "deliveries", "purchaserecords"
